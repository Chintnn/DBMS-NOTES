...
| **Outer Join** 🌎   | Includes unmatched rows from one or both tables. | 🏞️ |  
...
| **Cross Join** ❌ | Produces a **Cartesian Product** (every row of one table joins with every row of another). | ✖️ |  
